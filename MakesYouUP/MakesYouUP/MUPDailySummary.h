...
@interface MUPDailySummary : NSObject
...
@property (nonatomic, readonly) MUPEatSummary *eat_summary;
...
@property (nonatomic, readonly) MUPMoveSummary *move_summary;
...
@property (nonatomic, readonly) MUPSleepSummary *sleep_summary;
